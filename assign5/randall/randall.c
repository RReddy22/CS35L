...
main (int argc, char **argv)
{
  ...
  //input variables
  bool mrand48_r_flag = false; 
  char fileName[256] = "/dev/random"; 
  //malloc(sizeof(char)*strlen("/dev/random")); 
  //strcpy(fileName, "/dev/random"); 
  
  bool valid = process(argc, argv, &nbytes, &sizeOfbuffer, &mrand48_r_flag, fileName);
